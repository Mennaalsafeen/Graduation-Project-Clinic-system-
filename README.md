...
**Prepared by:** Menna Alsafeen, Weam Shahin, Taimaa Alsafeen, Shaimaa Madi, Hala Shbair  
**Team Leader:** Menna Alsafeen  
**Date:** 25/3/2026  
...
- The system should support different screen sizes.
...
| Taimaa Alsafeen | Backend Development | @username4 |
...
## Expected Features
The system is expected to provide the following features:
